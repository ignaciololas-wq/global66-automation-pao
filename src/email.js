...
export function providerInvitation({ providerName, profileUrl, sociedadContratante, solicitanteNombre }) {
...
<div style="max-width:560px;margin:32px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 8px 24px rgba(19,32,70,0.06)">
  ...
  <div style="padding:32px">
    <p style="margin:0 0 14px;color:#132046;font-size:15px;line-height:1.6">
      ${solicitanteNombre ?? 'Un equipo de Global66'} inició el proceso de alta para iniciar un contrato con tu empresa.
